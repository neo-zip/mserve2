...
const Help = (args) => {
   console.log(`\n${chalk.green('➜')} ${chalk.bold('More info about mserve at')} ${chalk.blueBright('https://neotap.net/mserve')}`);
   ...
   if (!args) {
      ...
      commands.forEach((e) => {
         console.log(`mserve ${chalk.blueBright(e.name)}${chalk.gray(e.args.map((e) => { return ' ' + e }))}`)
      });
